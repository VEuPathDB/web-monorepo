...
using the command `make docker-run`.  The files are exposed under the following
paths:

[source]
----
{URL}/clinepi/legacy/{file-name}
{URL}/clinepi/modern/{file-name}

{URL}/genomics/legacy/{file-name}
{URL}/genomics/modern/{file-name}

{URL}/mbio/legacy/{file-name}
{URL}/mbio/modern/{file-name}

{URL}/ortho/legacy/{file-name}
{URL}/ortho/modern/{file-name}
----

So for example, after running `make docker-run`, the URL
http://localhost:8082/genomics/modern/site-client.bundle.js may be used to fetch
