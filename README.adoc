...
== Prerequisites
* `Node >=24.0.0`
* `corepack` enabled (comes with Node.js 16.9.0+)
...
This will automatically use the Yarn version specified in `package.json` (`yarn@4.10.3`) when you run `yarn` commands in this repository.
