...
let dataSetProcessBasic: Array<{x: number[] | string[], y: number[] | string[], z: number[][]}> = []
...
let dataSetProcessCategorical: Array<{x: number[] | string[], y: number[] | string[], z: number[][]}> = []
...
let dataSetProcessCategoricalSmoothing: Array<{x: number[] | string[], y: number[] | string[], z: number[][]}> = []
