    ...
    return (
      <>
        ...
        >
          <tr
            style={{
              borderBottom: tableThickBorder,
              borderRight: tableThickBorder,
            }}
          >
            <td style={{}}>&nbsp;</td>
            <td style={{ borderRight: tableThickBorder }}>&nbsp;</td>
            <td style={tableRowHeaderStyle}>
              <b>value</b>
            </td>
            <td style={tableRowHeaderStyle}>
              <b>95% CI</b>
          ...
          <tr style={tableRowBorder}>
            <td style={tableFirstColumnHeaderStyle}>
              Association between 2 categorical variables
            </td>
            <td style={tableSecondColumnHeaderStyle}>
    ...
    return (
      <div>
        ...
        <ul>
          ...
          <ul>
            <li>
              The odds of having the disease specified in the columns (X-axis)
              was [<i>Odds Ratio</i>] times as high in those exposed to the
              potential risk factor indicated in the rows (Y-axis), as compared
              to those unexposed.
            </li>
          </ul>
        </ul>
        ...
        <ul>
          ...
          <ul>
            <li>
              The odds of having the disease specified in the columns (X-axis)
              was [<i>Odds Ratio</i>] times as high in those exposed to the
              potential risk factor indicated in the rows (Y-axis) in the time
              period of interest, as compared to those unexposed.
            </li>
          </ul>
        </ul>
        <br />
        ...
        <ul>
          <li>
            ...
            (for studies using a population at risk approach): [A / (A + B)] /
            [C / (C + D)]
          </li>
          <ul>
            <li>
        ...
        {shouldShowWarning && (
          <Banner
            banner={{
              ...
              // message is used as a basic text
              message:
                'The 2x2 contingency table must be properly constructed to correctly calculate statistics and interpret your results.',
              pinned: true,
              intense: false,
              additionalMessage: undefined,
              // text for showMore link
