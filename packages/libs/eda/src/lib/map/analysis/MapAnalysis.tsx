...
function MapAnalysisImpl(props: ImplProps) {
  ...
  // Note: temporary test data for Ez time filter
    ...
    series: [
      {
        ...
        y: [
          9.4667, 8.9338, 8.7881, 8.8275, 8.9666, 8.9188, 8.8984, 8.5207,
          8.8826, 8.8885, 8.918, 9.0428, 9.2326, 9.2678, 9.2778, 9.2791, 9.3129,
          9.3575, 9.547, 9.1614, 8.8183, 9.0783, 9.3669, 9.1692, 9.2234, 9.2269,
          9.3905, 9.3198, 9.0729, 9.4823, 9.2846, 9.2275, 9.0953, 9.2941,
          9.2566, 9.6933, 9.5211, 9.4618, 8.697, 8.718, 7.8882,
        ],
        binLabel: [
          ...
          <ShowHideVariableContextProvider>
            <DocumentationContainer>
              ...
              >
                ...
                {/* Time filter component: need to adjust props */}
                <DraggableTimeFilter
                  data={LineplotData}
                  zIndex={legendZIndex}
                  entities={studyEntities}
