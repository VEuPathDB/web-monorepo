...
export const ioBlastXConfig = record({
  ...
  task: optional(ioBlastXTask),
  wordSize: optional(number),
  gapOpen: optional(number),
  gapExtend: optional(number),
  maxIntronLength: optional(number),
  matrix: optional(ioBlastXScoringMatrix),
  threshold: optional(number),
  compBasedStats: optional(ioBlastCompBasedStats),
  seg: optional(ioBlastSegMask),
  softMasking: optional(boolean),
...
export const ioTBlastNConfig = record({
  ...
  xDropUngap: optional(number),
  parseDefLines: optional(boolean),
  task: optional(ioTBlastNTask),
  wordSize: optional(number),
  gapOpen: optional(number),
  gapExtend: optional(number),
  dbGenCode: optional(number),
  maxIntronLength: optional(number),
  matrix: optional(ioTBlastNScoringMatrix),
  threshold: optional(number),
  compBasedStats: optional(ioBlastCompBasedStats),
  seg: optional(ioBlastSegMask),
  softMasking: optional(boolean),
