...
import { Mesa, MesaState, Utils as MesaUtils } from '@veupathdb/wdk-client/lib/Components/Mesa';
import { MesaColumn, MesaDataCellProps, MesaSortObject } from '@veupathdb/wdk-client/lib/Core/CommonTypes';
import { wrappable } from '@veupathdb/wdk-client/lib/Utils/ComponentUtils';
import { bytesToHuman } from '@veupathdb/wdk-client/lib/Utils/Converters';

import { UserDataset, UserDatasetMeta, UserDatasetShare } from '@veupathdb/wdk-client/lib/Utils/WdkModel';
    ...
    return [
      ...
      },
      {
        callback: (userDatasets: UserDataset[]) => {
          ...
          if (!window.confirm(`Are you sure you want to delete ${noun}? ` + (affectedUsers.length ? `You have shared ${pronoun} with ${affectedUsers} users.` : ''))) return;
