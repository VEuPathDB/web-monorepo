...
export type InputPairProps<T extends object = object> = TextProps<T> | CheckboxProps<T>;

export function InputPair<T extends object = object>(props: InputPairProps<T>): ReactElement {
