...
function UserDatasetHelp ({ projectId, quotaSize }) {
  return projectId === 'MicrobiomeDB' ? (
    ...
    Taxon counts can be obtained from metagenome sequences through commonly available tools.
    Three of the most common ones (<a href="https://benjjneb.github.io/dada2">DADA2</a>, <a href="www.qiime.org">QIIME</a>, and <a href="www.mothur.org/wiki/Make.biom">Mothur</a>) have been integrated into workflows, and are available as a free online service, through NIAID's <a href="https://nephele.niaid.nih.gov/">Nephele</a> project.
          <h4>Formatting the input </h4>
    You can upload any file that contains processed taxonomic reads in a valid BIOM format. See <a href="http://biom-format.org/">this page</a> for examples. If your data is in a different format - for example TSV - you can use <a href="http://biom-format.org/documentation/biom_conversion.html">conversion tools</a> from the Python package <code>biom-format</code>.
          <h4>Sample Details</h4>
            ...
            <br/><br/>
    This <a href="http://biom-format.org/documentation/adding_metadata.html">documentation page</a> shows how to add sample details to a BIOM file using a tool <code>biom-add-metadata</code>.
    </section>
    <section>
    ...
    <div>
      <div className="row UserDataset-Help">
        <div className="box xs-12">
          <h2>Introduction</h2>
        <iframe src="https://www.youtube-nocookie.com/embed/igQZHjRBqV0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen width="560" height="315"></iframe>
        </div>
        <div className="box xs-12 md-6">
          <h2>VEuPathDB Galaxy</h2>
          <img src={tutStep2} />
          <ul>
            <li>Use the <b>VEuPathDB Export Tools</b> on the left-side navigation, at <Link to='/galaxy-orientation'>VEuPathDB Galaxy</Link>.</li>
            <li>Prepare your export data set by selecting the files (galaxy data sets) in your history. </li>
        ...
        <div className="box xs-12 md-6">
          ...
          <img src={tutStep3} />
          <ul>
            <li>You can now view, manage, share, and utilize your data set in <b>{projectId}</b>.</li>
            <li>My Data sets you’ve created contribute to a per-user upload limit/quota of <b>{bytesToHuman(quotaSize)}</b>.</li>
            <li> Bigwig files can be sent to JBrowse in the data set’s detail page.
                 Click the data set name or status icon to see this page.</li>
          </ul>
        </div>
      </div>
    </div>
