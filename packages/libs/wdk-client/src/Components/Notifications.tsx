...
import { _dequeueSnackbar, _displaySnackbar } from 'wdk-client/Actions/NotificationActions';

interface ReduxNotificationHandlerProps {
  children: ReactNode;
}

export function ReduxNotificationHandler({ children }: ReduxNotificationHandlerProps) {
