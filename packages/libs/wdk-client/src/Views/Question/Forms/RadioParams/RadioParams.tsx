...
import DefaultQuestionForm, { Props, Group } from 'wdk-client/Views/Question/DefaultQuestionForm';
...
export const RadioParams: React.FunctionComponent<Props> = props => {
  ...
  const [ activeRadioParam, updateActiveRadioParam ] = useState(radioParams[0] || '');
