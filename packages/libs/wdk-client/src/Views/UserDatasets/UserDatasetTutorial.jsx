...
function UserDatasetTutorial ({ projectName, quotaSize }) {
  ...
  return projectName === 'MicrobiomeDB' ? (
    ...
    <div>
      <div style={{ fontSize: '1.2em', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ fontSize: '1.4em', fontWeight: 500, lineHeight: 2 }}>You do not have any data sets.</div>
        <ul>
