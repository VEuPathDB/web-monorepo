...
import { MAX_ATTACHMENT_SIZE_DESCRIPTION } from '../../selectors/ContactUsSelectors';
...
const ContactUsAttachments: React.FC<Props> = ({
  changeFile,
  addFile,
  removeFile,
  ...
  <div className="contact-us-files">
    Attach up to three files (maximum {MAX_ATTACHMENT_SIZE_DESCRIPTION} per
    file).
