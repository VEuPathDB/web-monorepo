...
interface FastaOrthoSequenceFormState {
  attachmentType: string;
  includeOrganism: boolean;
  includeDescription: boolean;
  includeGroup: boolean;
}

interface FastaOrthoSequenceReporterFormProps {
  formState: FastaOrthoSequenceFormState;
  updateFormState: (formState: FastaOrthoSequenceFormState) => void;
  onSubmit: (event: React.MouseEvent<HTMLButtonElement>) => void;
  includeSubmit: boolean;
}

const FastaOrthoSequenceReporterForm: ReporterFormComponent = (
  props: FastaOrthoSequenceReporterFormProps
) => {
