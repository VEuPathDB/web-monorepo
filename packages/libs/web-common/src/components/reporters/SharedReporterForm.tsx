...
interface SharedReporterFormProps {
  scope: string;
  question: Question;
  recordClass: RecordClass;
  formState: SharedFormState;
  formUiState: SharedFormUiState;
  updateFormState: (state: SharedFormState) => void;
  updateFormUiState: (uiState: SharedFormUiState) => void;
  onSubmit: () => void;
...
const SharedReporterForm: React.FC<SharedReporterFormProps> & {
        ...
        <div className="eupathdb-ReporterFormGroup eupathdb-ReporterFormGroup__otherOptions">
          ...
          <div className="eupathdb-ReporterFormAddtionOptions">
            ...
            <div>
              <label>
                <Checkbox
                  value={formState.includeEmptyTables}
                  onChange={getUpdateHandler('includeEmptyTables')}
                />
...
SharedReporterForm.getInitialState = (downloadFormStoreState: State) => {
