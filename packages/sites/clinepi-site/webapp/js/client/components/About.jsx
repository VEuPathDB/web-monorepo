...
export default function About() {
  return (
    <div id="about">
      ...
      <div>
        <p>Yes! Our code is maintained using Subversion, and we welcome input from the community. Check out our <a href="https://cbilsvn.pmacs.upenn.edu/svn/apidb/ClinEpiWebsite/trunk/View/lib/R/shiny/apps/">scripts for each of the Shiny apps</a>.
        </p>
      </div>
