      ...
      <div className="ai-summary-flex-container">
        ...
        <div className="ai-disclaimer">
          <details>
            ...
            <p>
              The summaries shown on this website are generated by AI and are
              intended to assist interpretation of gene expression data. While
              we aim for accuracy, these summaries may occasionally misrepresent
              the underlying results.{' '}
              <strong>
                Please consult the actual gene expression data presented on this
                page before making decisions that could significantly affect
