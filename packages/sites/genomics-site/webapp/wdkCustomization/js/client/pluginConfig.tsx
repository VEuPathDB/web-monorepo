...
import {
  CompoundsByFoldChangeForm,
  GenericFoldChangeForm,
} from './components/questions/foldChange';
...
const apiPluginConfig: ClientPluginRegistryEntry<any>[] = [
  ...
  },
  {
    ...
    component: () => (
      <div style={{ margin: '2em', fontSize: '120%', fontWeight: 'bold' }}>
        The Popset Isolate Sequences geographical map is not available since
        Google has changed its Maps API products business model.
        <br />
        We are working on a new and improved map for a future release.
        <br />
        Feel free to <a href="/a/app/contact-us">contact us</a> with any
  ...
  },
  {
    ...
    test: ({ question }) => {
      return question?.queryName === 'GenesByPhenotypeEdaSubset';
    },
