...
export const userCommentRoutes: RouteEntry[] = [
...

  {
    ...
    component: (props: RouteComponentProps<{}>) => {
      ...
      return <UserCommentFormController {...parsedProps} />;
    },
  },
...

  {
    ...
    component: (props: RouteComponentProps<{}>) => {
      ...
      const initialCommentId =
        parseInt((props.location.hash || '#').slice(1)) || undefined;
...
function parseUserCommentQueryString(props: RouteComponentProps<{}>) {
  ...
  const target =
    targetId && targetType ? { id: targetId, type: targetType } : undefined;
  const externalDatabase =
    externalDbName && externalDbVersion
